...
export function bearerToken(req) {
    var _a;
    var h = (_a = req.header("authorization")) !== null && _a !== void 0 ? _a : req.header("Authorization");
    if (!h)
        return undefined;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, getAdminAuth().verifyIdToken(token)];
                case 2:
                    decoded = _b.sent();
                    return [2 /*return*/, decoded.uid];
                case 3:
                    _a = _b.sent();
                    return [2 /*return*/, null];
