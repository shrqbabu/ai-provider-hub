...
export function readKV(uid, key, fallback) {
    return __awaiter(this, void 0, void 0, function () {
        var snap, data;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, docRef(uid, key).get()];
                case 1:
                    snap = _b.sent();
                    if (!snap.exists)
                        return [2 /*return*/, fallback];
                    data = snap.data();
                    return [2 /*return*/, (_a = data === null || data === void 0 ? void 0 : data.v) !== null && _a !== void 0 ? _a : fallback];
            }
        });
    });
}
export function writeKV(uid, key, value, nowMs) {
    return __awaiter(this, void 0, void 0, function () {
        var doc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    doc = { v: value, updatedAt: nowMs };
                    return [4 /*yield*/, docRef(uid, key).set(doc)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function deleteKV(uid, key) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docRef(uid, key).delete()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
